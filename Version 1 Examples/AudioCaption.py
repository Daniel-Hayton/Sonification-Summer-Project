# Generate a sonification with an audio caption in `strauss` </u>
# Import the relevant modules:

# ***Note***: you will need to have some form of python text-to-speech installed (`TTS` or `pyttsx3`) for these
# examples to work. See the error raised when trying to run the examples below for more info:
