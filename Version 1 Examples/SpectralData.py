# Demonstrate `Spectraliser` Generator type to represent Data:</u>
...
# We consider a direct spectralisation approach where the sopund is generated by treating the 1D data as a sound
# spectrum! This uses a direct inverse Fourier transform.This seems relatively intuitive for spectral data,
# particular those with spectral features similar to what we can identify in sound.
...
# Example 1</u> &nbsp; **Comparing the NGC 1535 & NGC 6302 Spectra**
...
# What differences do you notice about the sounds? Can you here the presence/absence of spectral lines,
# and their relative pitches?
